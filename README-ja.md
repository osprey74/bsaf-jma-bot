...
本Botは「地震・火山・津波」（地象・海象）系の防災情報を担当します。気象警報・注意報や土砂災害・竜巻・大雨などの気象系情報は [bsaf-kikikuru-bot](https://github.com/osprey74/bsaf-kikikuru-bot) が担当します（役割分担については後述）。
